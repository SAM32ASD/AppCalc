...
//ADDING TO FRAME
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==bpts){  // Gestions des nombres décimaux
            zt=l1.getText();
            z=zt+".";
            l1.setText(z);
        }
        if(e.getSource()==bneg){ //Gestions des nombres négatifs
            zt=l1.getText();
            z="-"+zt;
            l1.setText(z);
        }
        if(e.getSource()==bback){  // Pour l'espace de travail
            zt=l1.getText();
            try{
        ...
        if(e.getSource()==badd){                     // ADDITION
            try{
                ...
                l1.setText("Erreur format invalid");
                return;
            }
            z="";
            l1.setText(z);
        ...
        if(e.getSource()==bsub){                    // SOUSTRACTION
            try{
                num1=Double.parseDouble(l1.getText());
            }catch(NumberFormatException f){
                l1.setText("Erreur format invalid");
        ...
        if(e.getSource()==bmult){                   // MULTIPLICATION
            try{
                num1=Double.parseDouble(l1.getText());
            }catch(NumberFormatException f){
                l1.setText("Erreur format invalid");
        ...
        if(e.getSource()==bmod){                  // MODULO/RESTE
            try{
                num1=Double.parseDouble(l1.getText());
            }catch(NumberFormatException f){
                l1.setText("Erreur format invalid");
